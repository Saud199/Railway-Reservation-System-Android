...
public class User_ViewScheduledTrain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__view_scheduled_train);

        trainList = (ListView) findViewById(R.id.Train_Schedulelist_user);
        trainsStatus = (TextView) findViewById(R.id.Train_Scheduletxt_user);

        scheduledTrains st = new scheduledTrains();
        st.execute("");

    }

    class scheduledTrains extends AsyncTask<String , String , String> {

        ProgressDialog p = new ProgressDialog(User_ViewScheduledTrain.this);
